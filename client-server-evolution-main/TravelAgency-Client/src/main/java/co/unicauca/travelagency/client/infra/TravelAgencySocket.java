...
public class TravelAgencySocket {
    ...
    public String sendRequest(String requestJson) throws IOException {
        ...
        Logger.getLogger(TravelAgencySocket.class.getName()).log(Level.INFO, "Lo que se le envia al: ("+requestJson+")");
        ...
        Logger.getLogger(TravelAgencySocket.class.getName()).log(Level.INFO, "Lo que se lee del servidor: ("+response+")");
